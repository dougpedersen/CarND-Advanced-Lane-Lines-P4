...
for idx, fname in enumerate(images):
    ...
    height_pct = 0.62 # % for trapezoid height (how far we're looking down the road) - 0.60 was a lot worse
    ...
    result = warped
    write_name = './test_images/warped/warp'+str(idx)+'.jpg'
    ...
    write_name = './test_images/tracked/trackedb'+str(idx)+'.jpg'
    #cv2.imwrite(write_name, result)
